...
## instrumentalness
En todos los archivos se levanto como un numero con notacion cientifica, lo llevamos a numero. Antes de hacer la conversion cambiamos una propiedad para evitar que R los siga forzando a notacion cientifica.

```{r correciones_instrumentalness}
##para evitar la notacion científica en campos pequeños o muy grandes
options(scipen = 999)
